...
class SummaryDownloadManager {
  ...
  generateDownloadableHTML(data) {
    ...
    const { videoInfo, summary, topics, processedTopics, topicConnections, processingState } = data;
    ...
    const isDetailed = processingState === 'completed' && processedTopics && processedTopics.length > 0;
    ...
    <div class="summary-container">
        ...
        <footer class="summary-footer">
            <div class="footer-content">
                ...
                <p class="original-url">Original video: <a href="${data.videoInfo.url || '#'}" target="_blank">${data.videoInfo.url || 'YouTube Video'}</a></p>
