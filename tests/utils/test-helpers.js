...
class TestUtils {
  ...
  static createMockVideoInfo(overrides = {}) {
    return {
      ...
      description: 'A comprehensive guide to basic science concepts for children aged 6-8',
      transcript: 'Hello kids! Today we are going to learn about amazing science. Science is everywhere around us. We can see it in plants, animals, and even in the sky. Let me show you some cool experiments that you can try at home safely.',
          ...
          content: {
            parts: [{
              text: JSON.stringify({
                topics: [
                  {
                    ...
                    content: 'Basic introduction to scientific concepts for kids'
                  },
                  {
                    id: 2,
                ...
                overallSummary: 'This video teaches kids about basic science through fun examples and experiments.'
              })
            }]
          }
        }]
          ...
          content: {
            parts: [{
              text: JSON.stringify({
                ...
                summary: 'Science is all around us and helps us understand how things work.',
                explanation: 'In this section, we learn that science helps us ask questions about the world. We can use our eyes to observe, our hands to touch, and our minds to think about what we discover.',
                keyPoints: [
                ...
                questions: [
                  {
                    ...
                    answer: 'Science is a way to learn about the world around us by asking questions and finding answers.'
                  },
                  {
                    question: 'Can kids do science experiments?',
                    answer: 'Yes! Kids can do many safe and fun science experiments with help from adults.'
                  }
                ]
              })
            }]
    ...
    global.fetch.mockImplementation((url, options) => {
      if (url.includes('generativelanguage.googleapis.com')) {
        ...
        return Promise.resolve({
          ok: true,
          status: 200,
          json: () => Promise.resolve(TestUtils.createMockGeminiResponse(responseType))
        });
      }
  ...
  static validateKidFriendlyContent(content) {
    ...
    const inappropriateWords = ['complex', 'complicated', 'sophisticated', 'intricate'];
    ...
    const kidFriendlyIndicators = ['fun', 'cool', 'amazing', 'kids', 'children', 'learn'];
...
export class TestDataFactory {
  ...
  static videoContent = {
    educational: {
      ...
      description: 'Learn about how plants grow from seeds to full plants in this fun educational video for children.',
      transcript: 'Hello kids! Today we are going to learn about plants. Plants start as tiny seeds. When we plant them in soil and give them water and sunlight, they begin to grow. First, a small root grows down into the soil. Then a green shoot grows up toward the sun. With more water and sunlight, the plant gets bigger and bigger until it becomes a full grown plant with leaves and maybe even flowers!'
    },
    entertainment: {
      title: 'Funny Cat Videos Compilation',
      description: 'Watch these hilarious cats doing silly things that will make you laugh.',
      transcript: 'Here are some funny cats doing silly things. This cat is trying to fit in a box that is too small. This one is chasing its own tail. And this cat thinks it is a dog!'
    },
    minimal: {
      title: 'Short Video',
      description: 'Brief content',
      transcript: 'Very short content that might not be suitable for summarization due to insufficient length.'
    }
  };
      ...
      candidates: [{
        content: {
          parts: [{
            text: JSON.stringify({
              topics: [
                { id: 1, name: 'Plant Growth', content: 'How plants grow from seeds' },
                { id: 2, name: 'What Plants Need', content: 'Water, sunlight, and soil requirements' }
              ],
              overallSummary: 'This video teaches kids how plants grow and what they need to be healthy.'
            })
          }]
        }
      }]
