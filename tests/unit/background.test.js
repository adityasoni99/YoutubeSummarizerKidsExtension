...
describe('Background Script Tests', () => {
  ...
  describe('URL validation', () => {
    test('should validate YouTube URLs correctly', () => {
      expect(flow.isYouTubeURL('https://www.youtube.com/watch?v=abc123')).toBe(true);
      expect(flow.isYouTubeURL('https://youtube.com/watch?v=abc123')).toBe(true);
    ...
    test('should extract video IDs correctly', () => {
      expect(flow.extractVideoId('https://www.youtube.com/watch?v=abc123')).toBe('abc123');
      expect(flow.extractVideoId('https://youtube.com/watch?v=def456')).toBe('def456');
